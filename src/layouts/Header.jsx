          ...
          <div className="row justify-content-between align-items-center flex-row g-2 g-sm-3 g-xl-4">
            <div className="col-auto">
              <div className="logo-section">
                <button
                  onClick={() => setmobileSlideBar((prev) => !prev)}
                  className="sidebar-toggle"
                >
                  <i
                    className={`demo-icon icon-toggle-1 ${mobileSlideBar ? 'd-block' : 'd-none'}`}
                  ></i>
                  <i
                    className={`demo-icon icon-left-arrow ${!mobileSlideBar ? 'd-block' : 'd-none'}`}
                  ></i>
                </button>
                <div className="logo">
