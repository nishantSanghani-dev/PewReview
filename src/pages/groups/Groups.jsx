  ...
  return (
    <td {...props.tdProps}>
      <div className="d-flex gap-2 align-items-center">
        <Link
          to={`/admin/groups/view/${props.dataItem.id}`}
    ...
    <td {...tdProps}>
      {endUserPermission?.canRead ? (
        <Link
          ...
          to={`/admin/manage-end-user/view/${dataItem.createdBy}`}
        >
          {dataItem.userName}
        </Link>
      ) : (
    ...
    <td {...tdProps}>
      {endUserPermission?.canRead ? (
        <Link
          ...
          to={`/admin/groups/view/${dataItem?.id}/members`}
        >
          {dataItem?.totalMember}
        </Link>
      ) : (
        <spam>{dataItem?.totalMember}</spam>
      )}
    </td>
  );
};
