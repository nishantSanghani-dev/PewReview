...
export default function GroupDetails() {
  ...
  const getGroupDetails = async () => {
    const res = await apiRequest(
      'GET',
      API_ROUTES.groups.getByGroupId(id),
      null,
      null,
      {
        showLoader: true,
                ...
                <tr>
                  ...
                  <td>
                    {endUserPermission?.canRead ? (
                      ...
                      <span>{grpData?.memberCount}</span>
                    )}
                  </td>
                </tr>

                <tr>
                  <td className="text-secondary">Reports</td>

                  <td>{grpData?.totalReports}</td>
                </tr>

                <tr>
                  <td className="text-secondary">Activities</td>
                  ...
                  <td>
                    {activityPermission?.canRead ? (
                      ...
                      <span>{grpData?.totalActivity}</span>
                    )}
                  </td>
                </tr>
              </tbody>
