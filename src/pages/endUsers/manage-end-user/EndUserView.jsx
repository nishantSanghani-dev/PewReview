...
export default function EndUserView() {
    ...
    const uploadGunView = async () => {
        const res = await apiRequest("POST", API_ROUTES.gun.gunListByUser, { page: 1, pageSize: 10, userId: id })
        console.log(res);
                            ...
                            <div className="border-contents">
                                <div className="row align-items-end gap-1">
                                    <div className="col">
                                        ...
                                        <p className="fw-medium mb-0 text-nowrap">{manageUserSingleData?.userName}</p>
                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <ul className="separater-list ps-0 d-flex flex-wrap mt-3">
                                            <li>
                                                <p className="dark-color fw-semibold large mb-0">{manageUserSingleData?.postsCount}</p>
                                                <p className="mb-0">Post</p>
                                            </li>
                                            <li>
                                                <p className="dark-color fw-semibold large mb-0">{manageUserSingleData?.followersCount}</p>
                                                <p className="mb-0">Followers</p>
                                            </li>
                                            <li>
                                                <p className="dark-color fw-semibold large mb-0">{manageUserSingleData?.followingCount}</p>
                                ...
                                <fieldset className="row">
                                    ...
                                    <div className="col-sm-6 mt-3">
                                        <div className="form-group">
                                            ...
                                            <select readOnly defaultValue={manageUserSingleData?.gender} className="form-select">
                                                <option>Male</option>
                                    ...
                                    <div className="col-sm-6 mt-3">
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                readOnly
                                                className="form-control text-capitalize"
                                                defaultValue={manageUserSingleData?.contectNumber ? manageUserSingleData?.contectNumber : '-'}
                                                id="contactNo"
                                                maxLength={10}
                                            />
                                        </div>
