...
export default function ManufacturerAdd({ id, getManufacturer, ismanufacturerOpen, setismanufacturerOpen }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const getSingleRecord = async () => {
        const res = await apiRequest("GET", API_ROUTES.manufacturer.manufacturerGetById(id), null, null, {
            showLoader: true
        })
        if (res.status) {
            reset({
    ...
    const onSubmit = async (data) => {
        ...
        if (id) {
            data.id = id
            res = await apiRequest("PUT", API_ROUTES.manufacturer.manufacturerUpdate(id), data, null, {
                showLoader: true,
                showToaster: true
            })
        }
