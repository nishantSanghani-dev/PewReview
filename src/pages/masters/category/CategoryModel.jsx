...
export default function CategoryModel({ isCategoryOpen, setisCategoryOpen }) {
    ...
    const getApplicationFor = async () => {
        const res = await apiRequest("GET", API_ROUTES.common.getGunApplicationFor, null, null, {
            showLoader: true
        })
    ...
    const onSubmit = async (data) => {
        ...
        const res = await apiRequest("POST", API_ROUTES.category.categoryAdd, payload, null, {
            showLoader: true,
            showToaster: true
        })
