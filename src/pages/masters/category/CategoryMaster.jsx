        ...
        <td {...props.tdProps}>
            <div className="form-check form-switch mb-0">
                <input
                    ...
                    readOnly
                    onChange={(e) => handleStatusChange(props.dataItem.categoryId, e.target.checked, "category", "categoryMasterUpdate", props.getCategoryMaster)}
                />
...
export default function CategoryMaster() {
    ...
    const getCategoryMaster = async () => {
        const res = await apiRequest("POST", API_ROUTES.category.getCategoryMaster, { page: 1, pageSize: 10 }, null, {
            showLoader: true
        })
