...
export default function ProhibitedAdd({ id, setid, isProhibitedOpen, setisProhibitedOpen, getProhibited }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const getSingleRecord = async () => {
        const res = await apiRequest("GET", API_ROUTES.prohibited.prohibitedSingleView, null, {
            id
        }, {
            showLoader: true
        })
    ...
    const onSubmit = async (data) => {
        ...
        if (id) {
            data.id = id
            res = await apiRequest("PUT", API_ROUTES.prohibited.prohibitedUpdate, data, null, {
                showLoader: true,
                showToaster: true
            })
        }
