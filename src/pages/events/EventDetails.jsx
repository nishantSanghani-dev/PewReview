...
export default function EventDetails() {
  ...
  const gteEventById = async () => {
    const res = await apiRequest(
      'GET',
      API_ROUTES.events.getEventById,
      null,
      {
        id,
      },
  ...
  return (
    <div className="container-fluid py-3">
      <BreadCumb
        items={[
          { label: 'Events', path: '/admin/events/view' },
          { label: 'Event Details' },
        ]}
      />
      ...
      <div className="row g-4">
        ...
        <div className="col-lg-5">
          ...
          <p className="event-ended mt-2">This Event has ended</p>
        </div>
        ...
        <div className="col-lg-7">
          ...
          <h2 className="event-title mt-3">{eventSingleData?.eventName}</h2>

          {/* Date */}
          <div className="info-row mt-4">
            <i className="demo-icon icon-calender-heart"></i>
            <span>
              {new Date(eventSingleData?.createdOn).toLocaleDateString(
                'en-GB',
                {
                  weekday: 'long',
                  day: '2-digit',
            ...
            <span>
              {new Date(eventSingleData?.startTime).toLocaleTimeString(
                'en-US',
                {
                  hour: 'numeric',
                  minute: '2-digit',
          ...
          <div className="info-row mt-4 align-items-start">
            ...
            <div>
              <h6 className="mb-1 fw-bold">{eventSingleData?.venueName}</h6>

              <p className="mb-0 text-muted">{eventSingleData?.address}</p>
            </div>
          </div>
      ...
      <div className="mt-5">
        ...
        <div className="detail-card">{eventSingleData?.details}</div>
      </div>

      {/* Hosts */}

      <div className="mt-5">
        <h3 className="section-title">Hosts</h3>
        ...
        <div className="host-card">
          <div className="row align-items-center">
            ...
            <div className="col">
              <h4 className="host-title">{eventSingleData?.venueName}</h4>

              <p className="mb-1 text-muted">{eventSingleData?.address}</p>
