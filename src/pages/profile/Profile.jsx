...
export default function Profile() {
    ...
    const fetchCommunication = async () => {
        const res = await apiRequest('GET', API_ROUTES.common.communicationWithDropdown, null, null, {
            useToken: true,
            showLoader: true
        })
    ...
    const fetchRoleData = async () => {
        const res = await apiRequest('GET', API_ROUTES.role.getRolesForDropdown, null, null, {
            useToken: true,
            showLoader: true
        })
