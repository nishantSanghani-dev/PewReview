...
export default function ProfileForm({ userProfile, genderData, countryData, communicationData, roleData, refreshProfile }) {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className=" ">
            <fieldset className="row gx-4 gy-4">
                ...
                <div className="col-12 col-lg-6">
                    <button type="button" className="btn main-btn border-btn danger-btn w-auto">Change Password</button>
                </div>
