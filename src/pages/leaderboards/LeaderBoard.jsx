...
export default function LeaderBoard() {
    ...
    const [leaderboardType, setLeaderboardType] = useState("Top 20 Gun Reviewers/Check-Ins");
            ...
            <div className="row g-2 my-4">
                ...
                <div className="col-12 col-md-3">
                    <div style={{ position: 'relative' }} ref={durationRef}>
                        ...
                        {isDurationOpen && (
                            <div className="dropdown-menu-static" style={{ position: 'absolute', zIndex: 10, width: '100%', top: '100%', background: '#fff', border: '1px solid #ced4da', borderTop: 'none', borderRadius: '0 0 6px 6px', overflow: 'scroll' }}>
                                {durationData.map((opt, idx) => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            background: duration === opt.description ? '#c62828' : 'transparent'
                                        }}
                                    >
                                        {opt.description}
                                    </div>
                ...
                <div className="col-12 col-md-4">
                    <div style={{ position: 'relative' }} ref={typeRef}>
                        ...
                        {isTypeOpen && (
                            <div className="dropdown-menu-static" style={{ position: 'absolute', zIndex: 10, width: '100%', top: '100%', background: '#fff', border: '1px solid #ced4da', borderTop: 'none', borderRadius: '0 0 6px 6px', overflow: 'hidden' }}>
                                {typeOptions.map((opt, idx) => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            background: leaderboardType === opt ? '#c62828' : 'transparent'
                                        }}
                                    >
                                        {opt}
                                    </div>
            ...
            <div className="row">
                <div className="col-12">
                    <div className="">
                        ...
                        >
                            <GridColumn field="rank" title="Rank" width="100px" cell={(props) => <TextCell {...props} field="rank" />} />
                            <GridColumn field="username" title="Username" cell={(props) => <TextCell {...props} field="username" />} />
                            <GridColumn field="followers" title="Followers" width="200px" cell={(props) => <TextCell {...props} field="followers" />} />
                            <GridColumn field="venueCheckIns" title="Venue Check-Ins" width="250px" cell={(props) => <TextCell {...props} field="venueCheckIns" />} />
                        </Grid>
